...
kicad-cli pcb drc "${PROJECT_BASE}.kicad_pcb" --format json --schematic-parity --output reports/drc.json --exit-code-violations

echo "Reports written to reports/erc.json and reports/drc.json"
